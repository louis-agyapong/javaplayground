...
public class CreditCard {
    ...
    public static void qualify() {
        JOptionPane.showMessageDialog(null, "Congratulations! " + "You qualify for the" +
                "credit card!");
    }

    /**
     * The noQualify method shows the user that he or she does not qualify for
     * the credit card.
     */

    public static void noQualify() {
        JOptionPane.showMessageDialog(null, "Sorry. You do not" +
