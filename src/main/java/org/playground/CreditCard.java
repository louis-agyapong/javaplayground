...
public class CreditCard {
    public static void main(String[] args) {
        ...
        input = JOptionPane.showInputDialog("What is your annual " +
                "salary?");
    ...
    /*
        The qualify method informs the user that he or she
        qualifies for the credit card.
    */
    ...
    /*
        The noQualify method informs the user that he or she
        does not qualify for the credit card.
     */
    public static void noQualify() {
        JOptionPane.showMessageDialog(null, "Sorry, you do not qualify for the " +
                "credit card.");
    }
}
