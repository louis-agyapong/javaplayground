 ...
 * the total sales and average total sales.
 */
...
public class SalesReport {
    ...
    /**
     * The display results method displays the total and average
     * daily sales.
     *
    ...
    public static void displayResults(double total, double avg) {
        ...
        JOptionPane.showMessageDialog(null, String.format("The total sales for the period is" +
